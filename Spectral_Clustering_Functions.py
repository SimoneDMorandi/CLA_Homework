...
In the following code three functions are defined.
...
def spectral_clustering(X, k, n_neighbors, sigma, Norm, random_state):
    ...
    First, the function builds the weight matrix for both sigma-neighborhood graph or fully connected graph according to
