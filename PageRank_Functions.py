...
def pagerank(A, m, tol=1e-12, max_iter=1000):
    ...
    with "m" as parameter. A check for convergence is done by confronting the norm of the new and the old eigenvector.
    In addiction to the maximum number of iteration, this check represents a stopping criterion.
    The i-th component of "r" is the importance score of the i-th page.
    """
    ...
    if sparse.issparse(A):
        ...
        A = A.multiply(1.0 / col_sums) # Preserving the sparsity.
    else:
